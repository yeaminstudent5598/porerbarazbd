...
    <section className="py-12 bg-gray-50">
      ...
      {/* ❗️ সমাধান: 
        আগের div-এ "container mx-auto px-4" ক্লাস ছিল, 
        যা এটিকে মাঝখানে আনছিল এবং খালি জায়গা তৈরি করছিল।
        এখন "container" এবং "mx-auto" বাদ দেওয়া হয়েছে।
      */}
      <div className=""> {/* <-- এই লাইনটি পরিবর্তন করা হয়েছে */}

        {/* হেডিং-এ px-4 যোগ করা হয়েছে যেন এটি কিনারে লেগে না থাকে */}
        <h2 className="text-2xl text-center font-bold text-gray-900 mb-6 px-4">
          Browse by Story
        </h2>
        
        <motion.div 
...
            className="flex w-max gap-3 md:gap-4 px-4" 
            drag="x"
