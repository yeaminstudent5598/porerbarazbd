...
const productData = [
    { id: 1, name: "কালোজিরা আচার", imageUrl: "/Images/pp1.jpeg", oldPrice: 1250, newPrice: 890, discount: "29%", description: "সম্পূর্ণ ঘরোয়া পরিবেশে, নিজস্ব তত্ত্বাবধানে বাছাইকৃত সেরা মানের কালোজিরা, রসুন, সরিষার তেল এবং অন্যান্য মশলা দিয়ে তৈরি। স্বাদে ও মানে অতুলনীয়।", rating: 4.5, reviews: 15, stock: 50, category: "Achar", weight: "500gm", ingredients: ["কালোজিরা", "রসুন", "সরিষার তেল", "মশলা"] },
    { id: 2, name: "ঝুড়ি পিঠা", imageUrl: "/Images/p5.jpeg", oldPrice: 850, newPrice: 790, discount: "7%", description: "চালের গুঁড়া দিয়ে তৈরি ঐতিহ্যবাহী মুচমুচে মজাদার ঝুড়ি পিঠা। বিকেলের নাস্তায় চায়ের সাথে অসাধারণ।", rating: 4.8, reviews: 22, stock: 30, category: "Pitha", weight: "1kg", ingredients: ["চালের গুঁড়া", "চিনি", "তেল"] },
    { id: 3, name: "রসুনের আচার", imageUrl: "/Images/pp2.jpeg", oldPrice: 850, newPrice: 690, discount: "19%", description: "রসুনের কোয়া দিয়ে তৈরি টক-ঝাল-মিষ্টি স্বাদের আচার।", rating: 4.7, reviews: 12, stock: 40, category: "Achar", weight: "400gm", ingredients: ["রসুন", "সরিষার তেল", "ভিনেগার", "মশলা"] },
    { id: 5, name: "ঝিনুক পিঠা", imageUrl: "/Images/p3.jpeg", oldPrice: 850, newPrice: 590, discount: "31%", description: "চিনির সিরায় ডোবানো মজাদার ঝিনুক পিঠা। দেখতে যেমন সুন্দর, খেতেও তেমন মজা।", rating: 4.6, reviews: 18, stock: 0, category: "Pitha", weight: "1kg", ingredients: ["ময়দা", "চিনি", "তেল", "এলাচ"] },
];
